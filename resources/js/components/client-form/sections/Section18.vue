<template>
    <div class="container">
            ...
            <yes-no collapse :label="formData[0].query" v-model="formData[0].answer" class="mb-4">
                <div class="asset-table mt-4">
                    <div class="row no-gutters">
                        <div class="col-9 cell-header">Description of Chattels</div>
        ...
        <content-box class="p-0 text-right" :shadow="false" :whiteBg="false">
            <button class="btn btn-primary shadow" @click="saveData('personal_belongings');routerPush('section19');">Next section</button>
        </content-box>
  </div>
</template>
