<template>
    <div class="container">
        <content-box title="Adding Executors">
            <p class="text-gray-500">Not every Executor may want to take on their role as an Executor for personal or
                other reasons. When this happens an Executor can choose one of the following:-</p>
            ...
            <p class="text-gray-500">Below is provision for the details of one executor to be inserted but there may be
                as many as four named in the Will and who may wish to take the Grant of Probate. In this case, click
                ‘add executor’ to add more.</p>
        </content-box>
        ...
        <content-box class="relative" v-for="(executor, key) in formData" :key="key" :title="`Executor ${key + 1}`">
            ...
            <base-input label="Forename" placeholder="John" v-model="executor.forename"></base-input>
            <base-input label="Surname" placeholder="Doe" v-model="executor.surname"></base-input>

            <div class="form-group">
                <label>Last usual address</label><br />
                <base-radio inline name="postcode" v-model="executor.addressInputType" value="manual">Find with
                    postcode</base-radio>
                <base-radio inline name="manual" v-model="executor.addressInputType" value="manual">Add
                    manually</base-radio>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-12" v-show="executor.addressInputType == 'manual'">
                    <div class="row">
                        <div class="col-lg-5">
                            <base-input label="Address Line 1" placeholder="23 Acacia Avenue"
                                v-model="executor.addressLine1"></base-input>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-5">
                            <base-input label="Address Line 2" placeholder="Acacia Road"
                                v-model="executor.addressLine2"></base-input>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-5">
                            <base-input label="Town / City" placeholder="Acacia" v-model="executor.town"></base-input>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-5">
                            <base-input label="Postcode" placeholder="TN28 PJ13"
            ...
            <div class="row">
                <div class="col-12 col-lg-6">
                    <base-input label="National insurance number" placeholder="576HDIW7 IE"
