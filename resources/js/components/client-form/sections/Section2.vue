  ...
  <div class="container">
    ...
    <content-box class="relative" v-for="(executor, key) in formData" :key="key" :title="`Executor ${key+1}`">
        ...
        <div class="form-group">
            ...
            <base-radio inline name="postcode" v-model="executor.addressInputType" value="manual">Find with postcode</base-radio>
            <base-radio inline name="manual" v-model="executor.addressInputType" value="manual">Add manually</base-radio>
        </div>
