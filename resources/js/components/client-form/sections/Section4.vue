            ...
            <yes-no collapse :label="formData[3].query" v-model="formData[3].answer">
                ...
                <div class="row">
                    <div class="col-lg-4 form-group">
                        ...
                        <datepicker input-class="form-control bg-white" v-model="formData[3].onTrue.date_of_death" placeholder="Date" format="dd / MM / yy"></datepicker>
                    </div>
                    <div class="col-lg-4 form-group">
                        <label>Date of marriage</label>
                        <datepicker input-class="form-control bg-white" v-model="formData[3].onTrue.date_of_marriage" placeholder="Date" format="dd / MM / yy"></datepicker>
                    </div>
                </div>
                <base-input
                        label="Forename"
