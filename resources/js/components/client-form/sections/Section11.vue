<template>
    <div class="container">
        <content-box title="Section 10 - Inheritance from other people">
            <p class="text-gray-500">If the deceased received a legacy of money or of an asset from another person in
                the last five years then please be alert to the details below.</p>
        </content-box>
        ...
        <content-box title="10.1 Inheritance">
            <yes-no :label="formData[0].query" v-model="formData[0].answer" collapse>
                ...
                <div class="row no-gutters">
                    ...
                    <div class="col-md-4">
                        <base-input type="number" placeholder="£200,000"
                ...
                <yes-no collapse :label="formData[0].onTrue.query1.query" v-model="formData[0].onTrue.query1.answer">
                    <div v-for="(doc, index) in formData[0].onTrue.query1.onTrue" v-show="activeDoc === index"
                        :key="index">
                        ...
                        <textarea v-model="doc.extra_details" class="form-control mb-4" rows="4"
                    ...
                    <div class="d-sm-flex align-items-center">
                        <div class="flex-grow-1 mb-3" v-show="formData[0].onTrue.query1.onTrue.length > 1">
                            ...
                            <a class="remove-doc" href="#" v-if="formData[0].onTrue.query1.onTrue.length > 1"
                        ...
                        <base-button type="default" outline @click="addDoc"
                            v-if="activeDoc + 1 == formData[0].onTrue.query1.onTrue.length">Add</base-button>
                        <base-button type="default" outline @click="activeDoc++"
                            v-if="activeDoc + 1 < formData[0].onTrue.query1.onTrue.length">Next</base-button>
                    </div>
                </yes-no>
            </yes-no>
        </content-box>
