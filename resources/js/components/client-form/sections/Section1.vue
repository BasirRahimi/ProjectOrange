<template>
    <div class="container">
        <content-box title="Welcome to Project Orange">
            <p class="text-muted m-0">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod
        ...
        <content-box title="About the Deceased">
            ...
            <base-input placeholder="Johnathan Doe" v-model="formData.aliases"
                label="Any aliases in which they held assets?"></base-input>

            <div class="form-group">
                <label>Last usual address</label><br />
                <base-radio inline name="postcode" v-model="addressInputType" value="manual">Find with
                    postcode</base-radio>
        ...
        <content-box title="1.2 Key Information">
            <div class="row">
                <div class="col-12 col-lg-6">
                    <base-input class="mb-3 mb-lg-0" label="Place of Birth" placeholder="Maidstone, Kent"
                        v-model="formData.place_of_birth" :form-group="false"></base-input>
                </div>
                <div class="col-12 col-lg-6">
                    <base-input label="Place of Death" placeholder="Wandsworth, London"
                        v-model="formData.place_of_death" :form-group="false"></base-input>
                </div>
            </div>
        </content-box>
        <content-box title="1.3 Marital Status">
            <div class="button-grid">
                <base-button type="default" outline :class="{ active: formData.marital_status == 'Married' }"
                    @click="formData.marital_status = 'Married'">Married</base-button>
                <base-button type="default" outline :class="{ active: formData.marital_status == 'Batchelor' }"
                    @click="formData.marital_status = 'Batchelor'">Batchelor</base-button>
                <base-button type="default" outline :class="{ active: formData.marital_status == 'Divorced' }"
                    @click="formData.marital_status = 'Divorced'">Divorced</base-button>
                <base-button type="default" outline :class="{ active: formData.marital_status == 'Widowed' }"
                    @click="formData.marital_status = 'Widowed'">Widowed</base-button>
                <base-button type="default" outline :class="{ active: formData.marital_status == 'Spinster' }"
                    @click="formData.marital_status = 'Spinster'">Spinster</base-button>
            </div>
        </content-box>
        <content-box title="1.4 Surviving Relatives">
            <div class="button-grid">
                <base-button type="default" outline @click="formData.spouse = !formData.spouse"
                    :class="{ 'active': formData.spouse }" class="col mr-3">Spouse</base-button>
                <base-button type="default" outline @click="updateSurvivingRelatives('parents')"
                    :class="{ 'active': formData.parents > 0 }" class="col mr-3">Parents</base-button>
                <base-button type="default" outline @click="updateSurvivingRelatives('siblings')"
                    :class="{ 'active': formData.siblings > 0 }" class="col mr-3">Siblings</base-button>
                <base-button type="default" outline @click="updateSurvivingRelatives('children')"
                    :class="{ 'active': formData.children > 0 }" class="col mr-3">Children</base-button>
